...
// instead of `sdk.NewGeodescriptionSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GeodescriptionSDK  { return NewGeodescriptionSDK(nil) }
func Test() *GeodescriptionSDK { return TestSDK(nil, nil) }
