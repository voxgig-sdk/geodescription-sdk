...
func NewTextPartEntity(client *core.GeodescriptionSDK, entopts map[string]any) *TextPartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TextPartEntity) GetName() string { return e.name }
...
func (e *TextPartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TextPartEntity) Deleted() bool {
	return e.deleted
}


func (e *TextPartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTextPartEntity(e.client, opts)
}

func (e *TextPartEntity) Data(args ...any) any {
...
func (e *TextPartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TextPart; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TextPartEntity) DataTyped(data ...TextPart) TextPart {
	if len(data) > 0 {
		return typedFrom[TextPart](e.Data(asMap(data[0])))
	}
	return typedFrom[TextPart](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TextPart (all fields
// optional at the wire level).
func (e *TextPartEntity) MatchTyped(match ...TextPart) TextPart {
	if len(match) > 0 {
		return typedFrom[TextPart](e.Match(asMap(match[0])))
	}
	return typedFrom[TextPart](e.Match())
}
...
func (e *TextPartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TextPartEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TextPartEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TextPartListMatch and returns []TextPart. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TextPartEntity) ListTyped(reqmatch TextPartListMatch, ctrl map[string]any) ([]TextPart, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TextPart](res), nil
}



func (e *TextPartEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TextPartEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TextPartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TextPartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
