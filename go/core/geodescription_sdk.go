...
func (sdk *GeodescriptionSDK) OptionsMap() map[string]any {
...
func (sdk *GeodescriptionSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GeodescriptionSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GeodescriptionSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GeodescriptionSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GeodescriptionSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GeodescriptionSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GeodescriptionSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GeodescriptionSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GeodescriptionSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GeodescriptionSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *GeodescriptionSDK {
	...
	sdk := NewGeodescriptionSDK(sdkopts)
	sdk.Mode = "test"
