...
const testSeed = `map[string]any{"entity": map[string]any{"lonlongitude": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reverse_geocoding": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "text_part": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
