...
function envOverride(m) {
    if ('TRUE' === process.env.GEODESCRIPTION_TEST_LIVE ||
        'TRUE' === process.env.GEODESCRIPTION_TEST_OVERRIDE) {
    ...
    m.GEODESCRIPTION_TEST_EXPLAIN = process.env.GEODESCRIPTION_TEST_EXPLAIN || m.GEODESCRIPTION_TEST_EXPLAIN;
    return m;
}
