...
(0, node_test_1.describe)('LonlongitudeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GeodescriptionSDK({
    ...
    (0, node_test_1.test)('direct-list-lonlongitude', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-lonlongitude', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["latitude01", "longitude01"]))
            return;
...
function liveScenariosActive() { return false && process.env.GEODESCRIPTION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GeodescriptionSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.GEODESCRIPTION_APIKEY,
        }));
        let idmap = env['GEODESCRIPTION_TEST_LONLONGITUDE_ENTID'];
    ...
    const client = new __1.GeodescriptionSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LonlongitudeDirect.test.js.map