...
(0, node_test_1.describe)('TextPartDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-text_part', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-text_part', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GEODESCRIPTION_TEST_TEXT_PART_ENTID'];
...
//# sourceMappingURL=TextPartDirect.test.js.map