...
local GeodescriptionSDK = {}
GeodescriptionSDK.__index = GeodescriptionSDK
...
GeodescriptionSDK._make_feature = _make_feature


function GeodescriptionSDK.new(options)
  local self = setmetatable({}, GeodescriptionSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GeodescriptionSDK:options_map()
...
function GeodescriptionSDK:get_utility()
  return Utility.copy(self._utility)
end


function GeodescriptionSDK:get_root_ctx()
  return self._rootctx
end


function GeodescriptionSDK:prepare(fetchargs)
...
function GeodescriptionSDK:direct(fetchargs)
...
-- by passing it.
function GeodescriptionSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GeodescriptionSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GeodescriptionSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function GeodescriptionSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GeodescriptionSDK.new(sdkopts)
  sdk.mode = "test"
