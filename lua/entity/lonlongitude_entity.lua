...
local LonlongitudeEntity = {}
LonlongitudeEntity.__index = LonlongitudeEntity


function LonlongitudeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LonlongitudeEntity)
  self._name = "lonlongitude"
  self._client = client
...
function LonlongitudeEntity:get_name()
  return self._name
end


function LonlongitudeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LonlongitudeEntity.new(self._client, opts)
end
...
function LonlongitudeEntity:mark_deleted()
  self._deleted = true
end


function LonlongitudeEntity:deleted()
  return true == self._deleted
end


function LonlongitudeEntity:data_set(args)
  if args ~= nil then
...
function LonlongitudeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LonlongitudeEntity:match_set(args)
  if args ~= nil then
...
function LonlongitudeEntity:match_get()
...
function LonlongitudeEntity:stream(action, args, callopts)
...
function LonlongitudeEntity:_run_op(ctx, post_done)
  local utility = self._utility
