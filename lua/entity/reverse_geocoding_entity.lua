...
local ReverseGeocodingEntity = {}
ReverseGeocodingEntity.__index = ReverseGeocodingEntity


function ReverseGeocodingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReverseGeocodingEntity)
  self._name = "reverse_geocoding"
  self._client = client
...
function ReverseGeocodingEntity:get_name()
  return self._name
end


function ReverseGeocodingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReverseGeocodingEntity.new(self._client, opts)
end
...
function ReverseGeocodingEntity:mark_deleted()
  self._deleted = true
end


function ReverseGeocodingEntity:deleted()
  return true == self._deleted
end


function ReverseGeocodingEntity:data_set(args)
  if args ~= nil then
...
function ReverseGeocodingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReverseGeocodingEntity:match_set(args)
  if args ~= nil then
...
function ReverseGeocodingEntity:match_get()
...
function ReverseGeocodingEntity:stream(action, args, callopts)
...
---@param reqmatch ReverseGeocodingLoadMatch
---@param ctrl? table
---@return ReverseGeocoding
---@return string? err
function ReverseGeocodingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ReverseGeocodingEntity:_run_op(ctx, post_done)
  local utility = self._utility
