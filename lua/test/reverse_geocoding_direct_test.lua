...
describe("ReverseGeocodingDirect", function()
  it("should direct-load-reverse_geocoding", function()
    local setup = reverse_geocoding_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reverse_geocoding", setup.live and "live" or "unit")
...
function reverse_geocoding_direct_setup(mockres)
