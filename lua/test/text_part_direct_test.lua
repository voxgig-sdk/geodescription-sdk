...
describe("TextPartDirect", function()
  it("should direct-list-text_part", function()
    local setup = text_part_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-text_part", setup.live and "live" or "unit")
...
function text_part_direct_setup(mockres)
