...
function runner.env_override(m)
  local live = runner.getenv("GEODESCRIPTION_TEST_LIVE")
  local override = runner.getenv("GEODESCRIPTION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GEODESCRIPTION_TEST_EXPLAIN")
