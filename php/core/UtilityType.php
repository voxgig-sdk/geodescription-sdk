...
// Geodescription SDK utility type

class GeodescriptionUtility
{
    ...
    public static function copy(GeodescriptionUtility $src): GeodescriptionUtility
    {
        $u = new GeodescriptionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
