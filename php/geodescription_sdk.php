...
class GeodescriptionSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = GeodescriptionHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = GeodescriptionHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!GeodescriptionFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, GeodescriptionFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return GeodescriptionUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = GeodescriptionHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = GeodescriptionHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = GeodescriptionHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new GeodescriptionError($op . "_allow",
                "GeodescriptionSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = GeodescriptionHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new GeodescriptionError("graphql_error",
                "GeodescriptionSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Lonlongitude($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_lonlongitude === null) {
                $this->_lonlongitude = new LonlongitudeEntity($this, null);
            }
            return $this->_lonlongitude;
        }
        return new LonlongitudeEntity($this, $data);
    }
    ...
    public function ReverseGeocoding($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_reverse_geocoding === null) {
                $this->_reverse_geocoding = new ReverseGeocodingEntity($this, null);
            }
            return $this->_reverse_geocoding;
        }
        return new ReverseGeocodingEntity($this, $data);
    }
    ...
    public function TextPart($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_text_part === null) {
                $this->_text_part = new TextPartEntity($this, null);
            }
            return $this->_text_part;
        }
        return new TextPartEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new GeodescriptionSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
