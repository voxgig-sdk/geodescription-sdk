...
// Geodescription SDK utility: fetcher

class GeodescriptionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GeodescriptionSDK/1.0)';
    ...
    public static function call(GeodescriptionContext $ctx, string $fullurl, array $fetchdef): array
    {
