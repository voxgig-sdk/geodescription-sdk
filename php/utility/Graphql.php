...
// Geodescription SDK utility: graphql
//
...
class GeodescriptionGraphql
{
    ...
    // equivalent.
    public static function body(GeodescriptionContext $ctx): mixed
    {
    ...
    public static function errors(GeodescriptionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
