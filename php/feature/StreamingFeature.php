...
// Geodescription SDK streaming feature
...
class GeodescriptionStreamingFeature extends GeodescriptionBaseFeature
{
    ...
    private function _iterate(GeodescriptionResult $result): \Generator
    {
    ...
    private function _streamable(GeodescriptionContext $ctx): bool
    {
