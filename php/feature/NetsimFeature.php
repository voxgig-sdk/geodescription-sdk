...
// Geodescription SDK netsim feature
...
class GeodescriptionNetsimFeature extends GeodescriptionBaseFeature
{
    ...
    private function _simulate(GeodescriptionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GeodescriptionContext $ctx, array $applied): void
    {
        $client = $this->client;
