...
// Geodescription SDK proxy feature
...
class GeodescriptionProxyFeature extends GeodescriptionBaseFeature
{
    ...
    public function init(GeodescriptionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GeodescriptionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
