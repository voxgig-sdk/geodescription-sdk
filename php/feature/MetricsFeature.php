...
// Geodescription SDK metrics feature
...
class GeodescriptionMetricsFeature extends GeodescriptionBaseFeature
{
    ...
    private function _record(GeodescriptionContext $ctx, bool $ok): void
    {
