...
// Geodescription SDK rbac feature
...
class GeodescriptionRbacFeature extends GeodescriptionBaseFeature
{
    ...
    private function _required(GeodescriptionContext $ctx): ?string
    {
    ...
    private function _reject(GeodescriptionContext $ctx, string $required): void
    {
    ...
    private function _track(GeodescriptionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
