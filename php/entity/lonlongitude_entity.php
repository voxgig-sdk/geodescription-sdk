...
// Geodescription SDK Lonlongitude entity
...
class LonlongitudeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LonlongitudeEntity($this->_client, $opts);
    }

    /**
     * @param Lonlongitude|array $args Lonlongitude data (assoc-array) to store.
     */
    ...
    /**
     * @return Lonlongitude|array The current Lonlongitude data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Lonlongitude fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Lonlongitude fields).
     */
     ...
     *
     * @param LonlongitudeListMatch|array|null $reqmatch Match filter (any subset
     *   of Lonlongitude fields) as an assoc-array; LonlongitudeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lonlongitude[]|array A list of Lonlongitude items as assoc-arrays at
     *   the SDK boundary; throws GeodescriptionError on failure (item-5 convention).
     */
