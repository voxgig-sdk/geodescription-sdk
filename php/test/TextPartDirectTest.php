...
class TextPartDirectTest extends TestCase
{
    public function test_direct_list_text_part(): void
    {
        $setup = text_part_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-text_part", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
