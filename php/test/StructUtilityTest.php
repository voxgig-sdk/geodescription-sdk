...
// Geodescription SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GeodescriptionOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GeodescriptionOmni::structfix($now, Struct::undef()))
                        !== json_encode(GeodescriptionOmni::structfix($val, Struct::undef()))) {
