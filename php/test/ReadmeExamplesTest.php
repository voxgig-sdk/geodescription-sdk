...
// Geodescription SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GeodescriptionSDK::test)
...
{
    private const SDK_CLASS = 'GeodescriptionSDK';
    ...
    private const SDK_BASE = 'geodescription_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../geodescription_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
