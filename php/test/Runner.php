...
class GeodescriptionTestRunner
{
    ...
    {
        $live = self::getenv('GEODESCRIPTION_TEST_LIVE');
        $override = self::getenv('GEODESCRIPTION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GEODESCRIPTION_TEST_EXPLAIN');
...
class_alias('GeodescriptionTestRunner', 'Runner');
class_alias('GeodescriptionHelpers', 'Helpers');
