...
module GeodescriptionTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("GEODESCRIPTION_TEST_LIVE")
    override = getenv("GEODESCRIPTION_TEST_OVERRIDE")
    ...
    explain = getenv("GEODESCRIPTION_TEST_EXPLAIN")
    m["GEODESCRIPTION_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GeodescriptionTestRunner
Helpers = GeodescriptionHelpers
Vs = VoxgigStruct
