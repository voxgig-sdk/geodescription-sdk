...
#      offline in seeded test mode (GeodescriptionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Geodescription_sdk.rb")
  SDK_CLASS = "GeodescriptionSDK"
