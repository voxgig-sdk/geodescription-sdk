# Geodescription Ruby SDK Reference

Complete API reference for the Geodescription Ruby SDK.
...
#### `GeodescriptionSDK.test(testopts = nil, sdkopts = nil)`
