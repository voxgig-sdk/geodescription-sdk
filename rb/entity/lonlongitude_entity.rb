...
class LonlongitudeEntity
  ...
  def make
    opts = @_entopts.dup
    LonlongitudeEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [LonlongitudeListMatch, Hash, nil] match filter (any subset of
  #   Lonlongitude fields); defaults to nil, treated as an empty match that lists all.
