...
AQL-driven CLI and REPL for the Geodescription SDK. Positional arguments are
...
./geodescription-cli load 1 lonlongitude
./geodescription-cli load '{id:1}' lonlongitude
