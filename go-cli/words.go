...
func registerSDKWords(r *eng.Registry, client *sdk.GeodescriptionSDK) {
...
func runOp(client *sdk.GeodescriptionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
