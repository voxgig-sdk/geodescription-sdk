// Command Geodescription-cli is a CLI + REPL for the Geodescription SDK,
...
const prompt = "geodescription"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "lonlongitude reverse_geocoding text_part"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GEODESCRIPTION_APIKEY (api key), GEODESCRIPTION_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: GEODESCRIPTION_APIKEY carries the API key and
	// GEODESCRIPTION_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("GEODESCRIPTION_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("GEODESCRIPTION_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewGeodescriptionSDK(opts)
