...
// Geodescription SDK timeout feature
...
class GeodescriptionTimeoutFeature extends GeodescriptionBaseFeature
{
    ...
    private function _with_timeout(GeodescriptionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GeodescriptionContext $_ctx, float $ms): void
    {
        $client = $this->client;
