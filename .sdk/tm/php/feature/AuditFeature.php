...
// Geodescription SDK audit feature
...
class GeodescriptionAuditFeature extends GeodescriptionBaseFeature
{
    ...
    private function _emit(GeodescriptionContext $ctx, string $outcome): void
    {
