...
// Geodescription SDK cache feature
...
class GeodescriptionCacheFeature extends GeodescriptionBaseFeature
{
    ...
    private function _through(GeodescriptionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
