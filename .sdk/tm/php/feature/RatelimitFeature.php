...
// Geodescription SDK ratelimit feature
...
class GeodescriptionRatelimitFeature extends GeodescriptionBaseFeature
{
    ...
    private function _acquire(GeodescriptionContext $ctx): void
    {
    ...
    private function _track(GeodescriptionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
