...
// Geodescription SDK clienttrack feature
...
class GeodescriptionClienttrackFeature extends GeodescriptionBaseFeature
{
    ...
    public function PostConstruct(GeodescriptionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Geodescription-SDK';
