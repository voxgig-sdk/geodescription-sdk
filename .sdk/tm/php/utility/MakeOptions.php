...
// Geodescription SDK utility: make_options

class GeodescriptionMakeOptions
{
    ...
    public static function call(GeodescriptionContext $ctx): array
    {
        ...
        //
        // `GeodescriptionSchema::optspec()` is built from the model:
        ...
        $optspec = GeodescriptionSchema::optspec();
