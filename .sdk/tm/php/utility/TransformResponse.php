...
// Geodescription SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class GeodescriptionTransformResponse
{
    public static function call(GeodescriptionContext $ctx): mixed
    {
        ...
        $transform = GeodescriptionHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
