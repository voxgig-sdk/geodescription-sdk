...
// Geodescription SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GeodescriptionMakeRequest
{
    public static function call(GeodescriptionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GeodescriptionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GeodescriptionResponse($fetched);
        } else {
