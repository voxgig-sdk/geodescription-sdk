...
class GeodescriptionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeodescriptionTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GeodescriptionTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GeodescriptionTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
