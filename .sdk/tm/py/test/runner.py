...
class GeodescriptionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeodescriptionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GeodescriptionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GeodescriptionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
