...
|---|---|---|
| `ts/` | @voxgig-sdk/geodescription-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/geodescription-sdk \
      --repository voxgig-sdk/geodescription-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/geodescription-sdk` shows it, and
`npm trust revoke @voxgig-sdk/geodescription-sdk --id=<id>` removes it.
