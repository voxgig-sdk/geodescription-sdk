...
from geodescription_sdk.utility import register

# Load features
from geodescription_sdk.feature.base_feature import GeodescriptionBaseFeature
from geodescription_sdk.features import _has_feature, _make_feature
...
class GeodescriptionSDK:
    ...
    def get_utility(self):
        return GeodescriptionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GeodescriptionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Lonlongitude(self, data=None) -> "LonlongitudeEntity":
        ...
        from geodescription_sdk.entity.lonlongitude_entity import LonlongitudeEntity
    ...
    def ReverseGeocoding(self, data=None) -> "ReverseGeocodingEntity":
        ...
        from geodescription_sdk.entity.reverse_geocoding_entity import ReverseGeocodingEntity
    ...
    def TextPart(self, data=None) -> "TextPartEntity":
        ...
        from geodescription_sdk.entity.text_part_entity import TextPartEntity
