...
from geodescription_sdk.core.control import GeodescriptionControl
...
from geodescription_sdk.core.helpers import get_ctx_prop, to_map
...
class GeodescriptionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = GeodescriptionControl()
        ...
        if isinstance(sp, GeodescriptionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GeodescriptionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GeodescriptionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return GeodescriptionOperation({})
    ...
    def make_error(self, code, msg):
        return GeodescriptionError(code, msg, self)
