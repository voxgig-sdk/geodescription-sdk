...
from geodescription_sdk.geodescription_types import (
    ReverseGeocoding,
...
class ReverseGeocodingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReverseGeocodingEntity(self._client, opts)
    ...
    def data_get(self) -> ReverseGeocoding:
    ...
    def match_get(self) -> ReverseGeocoding:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReverseGeocoding:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReverseGeocoding().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
