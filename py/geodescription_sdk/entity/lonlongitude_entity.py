...
class LonlongitudeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LonlongitudeEntity(self._client, opts)
    ...
    def data_get(self) -> Lonlongitude:
    ...
    def match_get(self) -> Lonlongitude:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Lonlongitude]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Lonlongitude().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
