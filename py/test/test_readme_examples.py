# Geodescription SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GeodescriptionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GeodescriptionSDK(...) and GeodescriptionSDK.test(...) become
#      GeodescriptionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "geodescription_sdk"
_SDK_CLASS = "GeodescriptionSDK"
