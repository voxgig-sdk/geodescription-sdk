...
type Args struct {
	Entity string         `json:"entity" jsonschema:"lonlongitude | reverse_geocoding | text_part"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GeodescriptionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "geodescription_list",
		Description: "List records from Geodescription. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "geodescription_load",
		Description: "Load a single record from Geodescription. " +
...
func runOp(client *sdk.GeodescriptionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GeodescriptionSDK, name string) (sdk.GeodescriptionEntity, error) {
	switch strings.ToLower(name) {
	case "lonlongitude":
		return client.Lonlongitude(nil), nil
	case "reverse_geocoding":
		return client.ReverseGeocoding(nil), nil
	case "text_part":
		return client.TextPart(nil), nil
