// Command Geodescription-mcp is an MCP server exposing the Geodescription
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Geodescription_list  — list records of an entity
//	Geodescription_load  — load a single record of an entity
//
