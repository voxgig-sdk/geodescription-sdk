...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/geodescription` | `npm install @voxgig-sdk/geodescription` |
| Python | `voxgig-sdk-geodescription` | `pip install voxgig-sdk-geodescription` |
| PHP | `voxgig-sdk/geodescription` | `composer require voxgig-sdk/geodescription` |
| Golang | `github.com/voxgig-sdk/geodescription-sdk/go` | `go get github.com/voxgig-sdk/geodescription-sdk/go` |
| Ruby | `voxgig-sdk-geodescription` | `gem install voxgig-sdk-geodescription` |
| Lua | `voxgig-sdk-geodescription` | `luarocks install voxgig-sdk-geodescription` |
